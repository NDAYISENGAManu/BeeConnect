...
import { api } from "../api";
import { ServiceApplications } from "../types/globalData";
...
interface TransferModalProps {
  visible: boolean;
  selectedRecord: ServiceApplications | null;
  onCancel: () => void;
...
const TransferModal: React.FC<TransferModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    const payload: any = {
      ...
      applications: selectedRecord ? [selectedRecord.key] : [],
    };
      ...
      >
        ...
        <Form layout="vertical">
          <div className="grid gap-6 m-0 p-0 md:grid-cols-2">
            {selectedRecord && (
              <div className="rounded-none text-center bg-[#ECF4F0] py-10">
                <p>
                  <strong>Application Details</strong>
                </p>
                <p>
                  <strong>Applicants Name: </strong> {selectedRecord.userName}
                </p>
                <p>
                  <strong>Application Contacts: </strong>{" "}
                  {selectedRecord.phoneNumber}
                </p>
                <p>
                  <strong>Service Applied: </strong>{" "}
            ...
            <div className="rounded-md">
              <div className="mb-3">
                <Form.Item
                  name="organization"
                  label={<span style={styles.label}>Organization</span>}
                  rules={[
                    {
                      required: true,
                ...
                <Form.Item
                  name="service"
                  label={<span style={styles.label}>Service</span>}
                  rules={[
